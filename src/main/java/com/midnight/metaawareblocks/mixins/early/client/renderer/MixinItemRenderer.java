...
public class MixinItemRenderer {
    ...
    private boolean doFirstRedirect(Block block, @Local(name="i") int x, @Local(name="j") int y, @Local(name="k") int z) {
    ...
    private boolean doSecondRedirect(Block block, @Local(name="i1") int x, @Local(name="j1") int y, @Local(name="k1") int z) {
        return block.isNormalCube(this.mc.theWorld, x, y, z);
    }
}
